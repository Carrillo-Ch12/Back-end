...
const Agregar= async (req, res) => {
    ...
    try {
      ...
      const [userData] = await connection.execute('SELECT lv.* FROM lista_videojuegos lv JOIN usuario u ON lv.Id_usuario = u.Id_usuarioWHERE u.Nombre_usuario = ?', [Nombre_usuario]);
      const Id_lista = userData[0].Id_usuario;
